...
def generate_initial_data_onecat_old(dimension_continuous,n_samples,random_state=123,verbose=0):
    np.random.seed(random_state)
    Xf = np.random.uniform(low=0,high=1,size=(n_samples,1))
    for i in range(dimension_continuous-4): ## We remove the 3 features which comme from the GMM
        np.random.seed(seed=random_state+i)
        curr_covariate = np.random.uniform(low=0,high=1,size=(n_samples,1))
        Xf = np.hstack((Xf,curr_covariate))
    ...
    z_p3 = np.eye(3) 
    z_p3[1,1]=0.1
    mu_p1 = np.array([2,2,0])
    mu_p2 = np.array([0,2,2])
    mu_p3 = np.array([2,0,2])
    
    X_gmm,z_plan = gmm_sampling(n_samples=n_samples,z=[1/3,1/3,1/3],
    ...
    z_feature_cat_uniform_plan1, z_feature_cat_uniform_numeric_plan1 = generate_synthetic_features_logreg(
        X=Xf_plan1,index_informatives=[0,1],list_modalities=['BC','A'],beta=np.array([-30,-30]),treshold=.5,intercept=45
    ) 
    ...
    z_feature_cat_uniform_plan2, z_feature_cat_uniform_numeric_plan2 = generate_synthetic_features_logreg(
        X=Xf_plan2,index_informatives=[1,2],list_modalities=['AC','B'],beta=np.array([-30,-30]),treshold=.5,intercept=55
    ) 
    ...
    z_feature_cat_uniform_plan3, z_feature_cat_uniform_numeric_plan3 = generate_synthetic_features_logreg(
        X=Xf_plan3,index_informatives=[0,2],list_modalities=['AB','C'],beta=np.array([-30,-30]),treshold=.5,intercept=70
    ) 
...
def generate_initial_data_onecat_close_2025_02_06(dimension_continuous,n_samples,random_state=123,verbose=0):
    np.random.seed(random_state)
    Xf=np.random.multivariate_normal(mean=np.zeros(dimension_continuous-3),cov=2*np.eye(dimension_continuous-3),size=n_samples)
    ...
    z_p3 = np.eye(3) 
    #z_p3[1,1]=0.1
    #mu_p1 = np.array([3,3,6])
    #mu_p2 = np.array([1,2,2])
    #mu_p3 = np.array([4,5,4])
    mu_p1 = np.array([3,3,6])
    mu_p2 = np.array([1,2,2])
    mu_p3 = np.array([4,5,4])
    ...
    #print('Xf_plan1 : ', Xf_plan1[:100,:3])
    z_feature_cat_uniform_plan1, z_feature_cat_uniform_numeric_plan1 = generate_synthetic_features_logreg(
        X=Xf_plan1,index_informatives=[0,1],list_modalities=['BC','A'],beta=np.array([-20,-20]),treshold=.5,intercept=75
    ) 
    print('z_feature_cat_uniform_plan1 : ', Counter(z_feature_cat_uniform_plan1))
    n_maj_plan1 = len(z_feature_cat_uniform_plan1[z_feature_cat_uniform_plan1=='BC'])
    z_feature_cat_uniform_plan1[z_feature_cat_uniform_plan1=='BC'] = np.random.choice(['B','C'], n_maj_plan1, replace=True)
    ...
    ## PLAN 2 : 
    z_feature_cat_uniform_plan2, z_feature_cat_uniform_numeric_plan2 = generate_synthetic_features_logreg(
        X=Xf_plan2,index_informatives=[1,2],list_modalities=['AC','B'],beta=np.array([-20,-20]),treshold=.5,intercept=35
    ) 
    print('z_feature_cat_uniform_plan2 : ', Counter(z_feature_cat_uniform_plan2))
    n_maj_plan2 = len(z_feature_cat_uniform_plan2[z_feature_cat_uniform_plan2=='AC'])
    z_feature_cat_uniform_plan2[z_feature_cat_uniform_plan2=='AC'] = np.random.choice(['A','C'], n_maj_plan2, replace=True)
    ...
    ## PLAN 3 :
    z_feature_cat_uniform_plan3, z_feature_cat_uniform_numeric_plan3 = generate_synthetic_features_logreg(
        X=Xf_plan3,index_informatives=[0,2],list_modalities=['AB','C'],beta=np.array([-1,-1]),treshold=.5,intercept=8.2
    ) 
    print('z_feature_cat_uniform_plan3 : ', Counter(z_feature_cat_uniform_plan3))
    n_maj_plan3 = len(z_feature_cat_uniform_plan3[z_feature_cat_uniform_plan3=='AB'])
    z_feature_cat_uniform_plan3[z_feature_cat_uniform_plan3=='AB'] = np.random.choice(['A','B'], n_maj_plan3, replace=True)
...
def generate_initial_data_onecat_v2(dimension_continuous,n_samples,random_state=123,verbose=0):
    np.random.seed(random_state)
    Xf=np.random.multivariate_normal(mean=np.zeros(dimension_continuous-3),cov=2*np.eye(dimension_continuous-3),size=n_samples)
...
def generate_initial_data_onecat_v3(dimension_continuous,n_samples,random_state=123,verbose=0):
    np.random.seed(random_state)
    ...
    z_p3 = np.eye(3) 
    #z_p3[1,1]=0.1
    mu_p1 = np.array([2,2,2])
    mu_p2 = np.array([1,1,1])
    mu_p3 = np.array([3,3,3])
    ...
    #print('Xf_plan1 : ', Xf_plan1[:100,:3])
    z_feature_cat_uniform_plan1, z_feature_cat_uniform_numeric_plan1 = generate_synthetic_features_logreg(
        X=Xf_plan1,index_informatives=[0,1,2],list_modalities=['BC','A'],beta=np.array([1,-2,-2]),treshold=.5,intercept=0.2
    ) 
    print('z_feature_cat_uniform_plan1 : ', Counter(z_feature_cat_uniform_plan1))
    n_maj_plan1 = len(z_feature_cat_uniform_plan1[z_feature_cat_uniform_plan1=='BC'])
    z_feature_cat_uniform_plan1[z_feature_cat_uniform_plan1=='BC'] = np.random.choice(['B','C'], n_maj_plan1, replace=True)
    ...
    ## PLAN 2 : 
    z_feature_cat_uniform_plan2, z_feature_cat_uniform_numeric_plan2 = generate_synthetic_features_logreg(
        X=Xf_plan2,index_informatives=[0,1,2],list_modalities=['AC','B'],beta=np.array([-1.5,-3,4]),treshold=.5,intercept=-8
    ) 
    print('z_feature_cat_uniform_plan2 : ', Counter(z_feature_cat_uniform_plan2))
    n_maj_plan2 = len(z_feature_cat_uniform_plan2[z_feature_cat_uniform_plan2=='AC'])
    z_feature_cat_uniform_plan2[z_feature_cat_uniform_plan2=='AC'] = np.random.choice(['A','C'], n_maj_plan2, replace=True)
    ...
    ## PLAN 3 :
    z_feature_cat_uniform_plan3, z_feature_cat_uniform_numeric_plan3 = generate_synthetic_features_logreg(
        X=Xf_plan3,index_informatives=[0,1,2],list_modalities=['AB','C'],beta=np.array([-1,2,-1]),treshold=.5,intercept=-0.3
    ) 
    print('z_feature_cat_uniform_plan3 : ', Counter(z_feature_cat_uniform_plan3))
    n_maj_plan3 = len(z_feature_cat_uniform_plan3[z_feature_cat_uniform_plan3=='AB'])
    z_feature_cat_uniform_plan3[z_feature_cat_uniform_plan3=='AB'] = np.random.choice(['A','B'], n_maj_plan3, replace=True)
...
def generate_initial_data_onecat_close_2025_02_10(dimension_continuous,n_samples,random_state=123,verbose=0):
    np.random.seed(random_state)
    Xf=np.random.multivariate_normal(mean=2*np.ones(dimension_continuous-3),cov=3*np.eye(dimension_continuous-3),size=n_samples)
    ...
    z_p3 = np.eye(3) 
    #z_p3[1,1]=0.1
    mu_p1 = np.array([1,1,3])
    mu_p2 = np.array([4,4,1])
    mu_p3 = np.array([2,2,2])
    ...
    #print('Xf_plan1 : ', Xf_plan1[:100,:3])
    z_feature_cat_uniform_plan1, z_feature_cat_uniform_numeric_plan1 = generate_synthetic_features_logreg(
        X=Xf_plan1,index_informatives=[0,1,2],list_modalities=['BC','A'],beta=np.array([1,-2,-2]),treshold=.5,intercept=1.2
    ) 
    print('z_feature_cat_uniform_plan1 : ', Counter(z_feature_cat_uniform_plan1))
    n_maj_plan1 = len(z_feature_cat_uniform_plan1[z_feature_cat_uniform_plan1=='BC'])
    z_feature_cat_uniform_plan1[z_feature_cat_uniform_plan1=='BC'] = np.random.choice(['B','C'], n_maj_plan1, replace=True)
    ...
    ## PLAN 2 : 
    z_feature_cat_uniform_plan2, z_feature_cat_uniform_numeric_plan2 = generate_synthetic_features_logreg(
        X=Xf_plan2,index_informatives=[0,1,2],list_modalities=['AC','B'],beta=np.array([-1.5,-3,4]),treshold=.5,intercept=5.5
    ) 
    print('z_feature_cat_uniform_plan2 : ', Counter(z_feature_cat_uniform_plan2))
    n_maj_plan2 = len(z_feature_cat_uniform_plan2[z_feature_cat_uniform_plan2=='AC'])
    z_feature_cat_uniform_plan2[z_feature_cat_uniform_plan2=='AC'] = np.random.choice(['A','C'], n_maj_plan2, replace=True)
...
def generate_initial_data_onecat_close_2025_02_11(dimension_continuous,n_samples,random_state=123,verbose=0):
    np.random.seed(random_state)
